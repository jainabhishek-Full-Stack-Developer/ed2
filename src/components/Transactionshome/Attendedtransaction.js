...
import {  dataAttendedTransaction } from "@/constant/dataTransaction";


const Attendedtransaction = () => {
    ...
    return (
        <div>
            {
                dataAttendedTransaction.length > 0 ? (
                    <section>
...
export default Attendedtransaction;
